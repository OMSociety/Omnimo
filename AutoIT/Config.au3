...
; The substituted WindowX/WindowY should be plain arithmetic (digits, decimal
; points, operators, parentheses). Evaluate only that; anything else, which
; could otherwise run arbitrary code through Execute(), is treated as a number.
